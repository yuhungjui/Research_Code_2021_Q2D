...
% ==============================================================================
% 
% Plot ISCCP cloud condition vs. IRBT over land from 1998–2018.
% 
% Input:
%       ISCCP:  monthly mean, 1-deg resolution, till Jun, 2017.
...
data_ISCCPim = nanmean(data_ISCCPi,3);
...
for cloudi = 1:numel(Cloud_range)-1
    ...
    Cloud_range_id = find( data_ISCCPi>=Cloud_range(cloudi) & data_ISCCPi<Cloud_range(cloudi+1) );
...
figname = ['./',ISCCP_var_name,'_IRBT_Climatology'];
