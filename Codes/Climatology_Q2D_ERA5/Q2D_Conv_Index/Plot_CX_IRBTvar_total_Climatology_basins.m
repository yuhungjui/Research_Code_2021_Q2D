...
% ==============================================================================
% 
% Plot ERA5 vs. IRBT over land from 1998–2019.
% 
...
%% Get IRBT total var over targeted area:
...
% leg1 = legend([f11{1},f11{3},ftmp_dc,ftmp_q2d],{'IO','WPAC','DC','Q2D'});
% leg1 = legend([f11{4},f11{7},ftmp_dc,ftmp_q2d],{'Congo','Amazon','DC','Q2D'});
leg1 = legend([f11{5},f11{6},ftmp_dc,ftmp_q2d],{'S.America','CONUS','DC','Q2D'});
