...
for basini = [1,3]
    ...
    data_IRBTvari_q2d_basin = data_IRBTvari_q2d_ocean(basin_id);
    data_IRBTvari_dc_basin = data_IRBTvari_dc_ocean(basin_id);
...
figname = ['./',ERA5_CX_var_name,'_IRBTvar_Climatology_Basins_Ocean'];
