...
% ==============================================================================
% 
% Plot IRBT variance difference map between [ Q2D ] & [ DC ] over all time (1998–2018).
% 
% ==============================================================================
...
VarSig_Map_both = VarSig_Map_dc.*VarSig_Map_q2d;

% Var_Map_bySig_dc = Var_Map_dc.*VarSig_Map_dc;
% Var_Map_bySig_q2d = Var_Map_q2d.*VarSig_Map_q2d;
Var_Map_bySig_dc = Var_Map_dc.*VarSig_Map_both;
Var_Map_bySig_q2d = Var_Map_q2d.*VarSig_Map_both;

%% Get Var Maps:

switch mon_id
    case 0
        VarDiff_Map = Var_Map_q2d-Var_Map_dc;
    otherwise
        VarDiff_Map = Var_Map_q2d(:,:,target_month_id{mon_id})-Var_Map_dc(:,:,target_month_id{mon_id});
end
...
cm = redblue(16);
% cm(11:12,:) = [0.95,0.95,0.95;0.95,0.95,0.95];

colormap(cm);
cb = colorbar;

% set(cb,'YTick',[0:20:200])
set(cb,'YTick',[-200:20:200])
% set(cb,'YTick',[-210:60:210])
...
switch mon_id
    case 0
        leg1_label = {['Q2D var. - DC var.']};
    otherwise
        leg1_label = ['Q2D var. - DC var. (',target_month_name{mon_id},')'];
end
...
switch mon_id
    case 0
        figname = ['./IRBT_Var_Diff_Climatology'];
    otherwise
        figname = ['./IRBT_Var_Diff_Climatology_',target_month_name{mon_id}];
end
